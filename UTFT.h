...
// #define TEXT_ALIGN_RIGHT 9999
// #define TEXT_ALIGN_CENTER 9998
...
class UTFT
{
	public:
	   ...
	   void drawString(String text, int x, int y, int deg=0);

	   // Draws a String with a maximum width at the given location.
	   // If the given String is wider than the specified width
	   // The text will be wrapped to the next line at a space or dash
	   void drawStringMaxWidth(String text, int x, int y, int maxLineWidth, int deg=0);
